...
export default function PageHero({ title, subtitle, breadcrumb }: PageHeroProps) {
  return (
    <section className="relative bg-navy overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_#1B2F5E,_#0D1F45)]" />
      ...
      <div className="relative py-24 lg:py-32 text-center">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {breadcrumb && (
            <p className="text-xs text-lime/70 uppercase tracking-[0.2em] mb-4 font-display font-semibold">
              {breadcrumb}
            </p>
          )}
