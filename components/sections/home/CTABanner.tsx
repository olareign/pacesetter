...
export default function CTABanner() {
  return (
    <section className="relative bg-navy overflow-hidden py-24 lg:py-32">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,#1B2F5E,#0D1F45)]" />
      <div className="absolute top-0 right-0 w-100 h-100 bg-lime/5 rounded-full blur-[120px]" />
      <div className="absolute bottom-0 left-0 w-75 h-75 bg-white/3 rounded-full blur-[100px]" />
